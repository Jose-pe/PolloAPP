...
<section class="mt-4 d-flex justify-content-center">
    <form action="" class="w-50 p-3" method="POST">
    ...
    <div class="input-group input-group-lg mb-3">
             <input type="text" value="{{$mesa->nrosillas}}" name="nrosillas" class="form-control" required placeholder="Numero de sillas de la mesa">
    </div>
    ...
    <div class="input-group input-group-lg d-flex justify-content-center mb-3">
            <button class="btn btn-primary btn-lg">Modificar Mesa</button>
   </div>
